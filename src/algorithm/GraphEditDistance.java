...
public class GraphEditDistance {
	...
	public GraphEditDistance(Graph g1, Graph g2, double subCost, double insCost, double delCost,
			Map<String, Double> posEditWeights, Map<String, Double> deprelEditWeights) {
	...
	public GraphEditDistance(Graph g1, Graph g2, Map<String, Double> posEditWeights,
	...
	public double getNormalizedDistance() {
		/**
		 * Retrieves the approximated graph edit distance between the two graphs g1 &
		 * g2. The distance is normalized on graph length
		 */
	...
	public double[][] createCostMatrix() {
		 ...
		 * delete operations which should have any cost, and is filled with zeros.
		 */
